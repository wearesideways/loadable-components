...
> This method does not return a Promise intentionally. If you need to know when a component has been loaded at this time, you are probably doing something wrong.
